...
class StartMessage extends GameObject{
    ...
    constructor() {
        ...
        this.texts[0] = Util.newTextField("ドリ走", Util.width / 12, FONT_COLOR, 0.5, 0.2, true, false);
        this.texts[1] = Util.newTextField("タッチ中は右へドリフト", Util.width / 19, FONT_COLOR, 0.5, 0.3, true, false);
        this.texts[2] = Util.newTextField("華麗にドリフトを決めろ！", Util.width / 19, FONT_COLOR, 0.5, 0.35, true, false);
